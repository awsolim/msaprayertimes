  ...
  return (
    ...
    <h3 className="font-mono text-[85px] text-white -translate-y-8">
      {isAdhanStage ? "Adhan" : "Iqamah"} in
        ...
        <div className="-translate-x-8 flex justify-center items-end gap-4 md:gap-6 font-mono mb-10">
          {/* HOURS */}
          <div className="min-w-[110px]">
            <div className="-translate-x-9 text-6xl md:text-[270px] font-extrabold">{hh}</div>
          ...
          <div className="min-w-[85px]">
            <div className="-translate-x-6 text-6xl md:text-[270px] font-extrabold">{mm}</div>
          ...
          {/* SECONDS */}
          <div className="min-w-[110px]">
            <div className="-translate-x-3 text-6xl md:text-[270px] mr-8 font-extrabold">{ss}</div>
            <div className="text-sm md:text-[30px] tracking-[0.4em] mt-3 bg-white/10 rounded-xl px-4 py-2 inline-block">
              SECONDS
            </div>
          </div>
